...
from recipes.views import (AddAndDeleteSubscribe, AddDeleteFavoriteRecipe,
                           AddDeleteShoppingCart, CustomUserViewSet,
                           DownloadShoppingCart, IngredientViewSet,
                           RecipeViewSet, SubscriptionsView, TagViewSet)
